...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=924ACA&width=435&lines=%F0%9F%91%8B+Hey%2C+I'm+Raphael)](https://git.io/typing-svg) ![Python](https://img.shields.io/badge/Python-Expert-blue)
...
- 🧪 Experiment with deep learning and neural networks
- 🚀 Work on personal AI/ML projects and share what I learn
...
- Transformer models and Natural Language Processing (NLP)  
- Building end-to-end machine learning pipelines  
- Deploying AI apps with Streamlit and FastAPI  
- Solving real-world problems using open datasets
...
- Threads: [@codewithraphael](https://threads.net/@codewithraphael)
